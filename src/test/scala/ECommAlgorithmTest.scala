...
class ECommAlgorithmTest
  ...
  val i0 = Item(item_type = "content", categories = Some(Seq("c0", "c1")), brand = None, cosmetics = None, upload_date = None)
  val i1 = Item(item_type = "content", categories = None, brand = None, cosmetics = None, upload_date = None)
  val i2 = Item(item_type = "content", categories = Some(Seq("c0", "c2")), brand = None, cosmetics = None, upload_date = None)
  ...
  val scrap = Seq(
    ScrapEvent("u0", "i0", 1000020, true),
    ScrapEvent("u0", "i1", 1000030, false),
    ScrapEvent("u1", "i1", 1000040, false)
  )
